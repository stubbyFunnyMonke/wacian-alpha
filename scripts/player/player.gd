...
func _physics_process(delta): #renderstepped :flushed:
	...
	input_vector.x = Input.get_action_raw_strength("walkright") - Input.get_action_strength("walkleft")
	input_vector.y = Input.get_action_strength("ui_down") - Input.get_action_strength("walkup")
